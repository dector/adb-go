...
8. When presenting results or discussing implementation, include an educational, useful explanation rather than a brief summary. Cover what changed, why it exists, how it contributes to the final project goal, and how the relevant part of ADB/the code works. Explain the important protocol or code flow step by step, define project-specific terms when they first appear, and connect the implementation to the tests so a reviewer can understand both behavior and intent.
